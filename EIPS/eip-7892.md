...
### Modified base fee computations
...
In line with [EIP-7691](./eip-7691.md), they always use the current blob schedule, i.e., the blob schedule of the block in which they are being used.
